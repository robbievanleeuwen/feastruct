...
analysis.add_support(node_id=1, val=0, dir=3)
analysis.add_support(node_id=2, val=0, dir=1)
analysis.add_support(node_id=3, val=0, dir=1)
analysis.add_support(node_id=3, val=0, dir=2)
analysis.add_support(node_id=4, val=0, dir=3)
analysis.add_support(node_id=5, val=0, dir=2)
analysis.add_support(node_id=7, val=0, dir=2)
analysis.add_support(node_id=7, val=0, dir=3)
analysis.add_support(node_id=8, val=0, dir=1)
analysis.add_support(node_id=8, val=0, dir=3)
analysis.add_support(node_id=11, val=0, dir=1)
analysis.add_support(node_id=11, val=0, dir=2)

analysis.add_support(node_id=6, val=0.1, dir=1)
analysis.add_support(node_id=9, val=-10, dir=2)
analysis.add_support(node_id=5, val=-1, dir=3)

analysis.add_nodal_load(node_id=2, val=-1, dir=2)
analysis.add_nodal_load(node_id=10, val=1, dir=1)
analysis.add_nodal_load(node_id=11, val=-1, dir=3)
