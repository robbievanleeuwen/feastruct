...
static_solver = LinearStatic(analysis, case_ids=[1]).solve()
...
buckling_solver = LinearBuckling(analysis, case_id=1).solve()

post.plot_eigenvector(case_id=1, buckling_mode=1)
post.plot_eigenvector(case_id=1, buckling_mode=2)
post.plot_eigenvector(case_id=1, buckling_mode=3)
post.plot_eigenvector(case_id=1, buckling_mode=4)
